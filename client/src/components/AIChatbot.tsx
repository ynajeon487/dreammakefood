  ...
  return (
    <>
      {!isOpen && (
        <Button
          size="icon"
          style={{ position: 'fixed', bottom: '32px', right: '32px', left: 'auto' }}
      ...
      {isOpen && (
        <Card style={{ position: 'fixed', bottom: '32px', right: '32px', left: 'auto' }} className="w-[380px] h-[600px] flex flex-col shadow-2xl z-50">
