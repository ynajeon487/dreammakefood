  ...
  return (
    <>
      {!isOpen && (
        <Button
          size="icon"
          className="fixed bottom-6 right-6 left-auto h-14 w-14 rounded-full shadow-lg bg-accent hover:bg-accent text-accent-foreground z-50"
      ...
      {isOpen && (
        <Card className="fixed bottom-6 right-6 left-auto w-[380px] h-[600px] flex flex-col shadow-2xl z-50">
