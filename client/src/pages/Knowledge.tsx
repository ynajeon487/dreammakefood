  ...
  const articles = [
    {
      ...
      excerpt: 'Khám phá những bí quyết giúp bạn nấu ăn ngon mà vẫn tiết kiệm chi phí hiệu quả.',
      category: 'Mẹo nấu ăn',
      readTime: 5,
      date: '15/01/2025',
    },
    {
      ...
      excerpt: 'Hướng dẫn chi tiết cách bảo quản rau củ, thịt cá để giữ tươi lâu và giảm lãng phí.',
      category: 'Bảo quản',
      readTime: 7,
      date: '12/01/2025',
    },
    {
      ...
      excerpt: 'Cách tính toán dinh dưỡng và lập thực đơn cân bằng cho một tuần.',
      category: 'Dinh dưỡng',
      readTime: 10,
      date: '08/01/2025',
    },
    {
      ...
      excerpt: 'Danh sách các nguyên liệu có thể thay thế khi không tìm thấy hoặc giá cao.',
      category: 'Mẹo nấu ăn',
      readTime: 6,
      date: '05/01/2025',
    },
    {
      ...
      excerpt: 'Bí quyết chọn mua nguyên liệu tươi ngon với giá tốt nhất tại chợ truyền thống.',
      category: 'Mua sắm',
      readTime: 8,
      date: '01/01/2025',
    },
    {
      ...
      excerpt: 'Những món đồ dùng nhà bếp thiết yếu và tiết kiệm cho sinh viên tự nấu.',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {articles.map((article) => (
              <Card 
                key={article.id} 
                className="p-6 hover-elevate active-elevate-2 transition-all hover:-translate-y-1 cursor-pointer"
