...
const ingredientPrices: Record<string, IngredientPriceInfo> = {
  ...
  // Trái cây (giá tham khảo từ Bách Hóa Xanh - tháng 1/2025)
  chuối: {
    defaultQuantity: 5,
    unit: "trái",
    baseUnitPrice: 10000,
  ...
  cam: {
    ...
    unit: "trái",
    baseUnitPrice: 5000,
    displayPriceUnit: "5.000đ/trái",
  },
  "cam sành": {
    defaultQuantity: 5,
    unit: "trái",
    baseUnitPrice: 4000,
    displayPriceUnit: "4.000đ/trái",
  },
  bưởi: {
    defaultQuantity: 2,
    unit: "trái",
    baseUnitPrice: 35000,
    displayPriceUnit: "35.000đ/trái",
  },
  "đu đủ": {
    defaultQuantity: 500,
    unit: "g",
  ...
  xoài: {
    ...
    unit: "trái",
    baseUnitPrice: 20000,
    displayPriceUnit: "20.000đ/trái",
  },
  "thanh long": {
    defaultQuantity: 3,
    unit: "trái",
    baseUnitPrice: 12000,
    displayPriceUnit: "12.000đ/trái",
  },
  "dưa hấu": {
    defaultQuantity: 1,
    unit: "trái",
    baseUnitPrice: 30000,
    displayPriceUnit: "30.000đ/trái (~3kg)",
  },
  "dưa lưới": {
    defaultQuantity: 1,
    unit: "trái",
    baseUnitPrice: 41000,
    displayPriceUnit: "41.000đ/trái",
  },
  mận: {
    defaultQuantity: 500,
    unit: "g",
